...
// TODO: once const generics have stabilized and we are able to use `bitvec = 0.22`, change
// `BitView` to `BitViewSized`.
#[cfg(feature = "bits")]
pub use bitvec::view::BitView;
#[cfg(feature = "derive")]
pub use fff_derive::PrimeField;
...
pub trait PrimeFieldBits: PrimeField {
    ...
    // TODO: change `BitView` to `BitViewSized` once const generics have been stabilized.
